                             ...
                             int width, int height, p_pixel_datas new_pic, p_pixel_datas old_pic)
{
    ...
    if ((start_x_new_pic < 0 || start_x_new_pic >= new_pic->width)  || (start_y_new_pic < 0 || start_y_new_pic >= new_pic->height) || (start_x_old_pic < 0 || start_x_old_pic >= old_pic->width)  || (start_y_old_pic < 0 || start_y_old_pic >= old_pic->height))
    {
        return -1;
    }
